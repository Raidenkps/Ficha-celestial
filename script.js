document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateStats = () => {
    ...
    const cansaco = parseInt(document.getElementById("cansaco").value);
    const cansacoMax = parseInt(document.getElementById("cansacoMaximo").value);
    ...
    document.getElementById("cansacoMaximo").value = cansacoMax;

    // Exibindo cansaço atual e máximo
    document.getElementById("cansaco").value = cansaco;
    document.getElementById("cansacoMaximo").value = cansacoMax;
  };
